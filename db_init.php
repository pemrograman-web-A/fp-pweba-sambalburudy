...
try {
    ...
    $insertData = [
        ...
        ('BR004', 'Sambal Bawang Sachet (Box)', 'Kemasan travel friendly isi praktis.', 37000, 100, 'Sambal Bawang Sachet Bu Rudy.png', 'Sambal'),
        ('BR005', 'Spikoe Kismis', 'Lapis Surabaya klasik dengan kismis.', 125000, 50, 'spikoe kismis.webp', 'Kue'),
        ('BR006', 'Otaji Oseng Tuna Asap', 'Tuna asap pedas (500gr).', 85000, 75, 'Oseng Tuna Asap Otaji.png', 'Lauk'),
